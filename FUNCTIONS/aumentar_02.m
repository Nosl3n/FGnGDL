    ...
    if length(cambios) ~= 0
        for i = 1:length(cambios)
            if cambios(i) == length(nuevas_distancias)
                ...
                Lnew = dis1(cambios(i)) / 6 + dis1(1) / 6; %distancia en la que se pone el nuevo punto (aumentar: 4)
            else
                angulo = ang1(cambios(i)) + (nuevas_distancias(cambios(i)) / 2);
                Lnew = dis1(cambios(i)) / 6 + dis1(cambios(i) + 1) / 6; %distancia en la que se pone el nuevo punto (aumentar: 4)
            end
